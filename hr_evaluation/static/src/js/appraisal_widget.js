odoo.define('hr_appraisal.FieldAppraisal', function (require) {
"use strict";
...
var ResumeLineRenderer = AbstractGroupedOne2ManyRenderer.extend({
    ...
    dataRowTemplate: 'hr_appraisal_data_row',
...
var FieldAppraisal = FieldOne2Many.extend({
...
field_registry.add('hr_appraisal', FieldAppraisal);

return FieldAppraisal;
